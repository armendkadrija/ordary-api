...
namespace Odary.Api.Migrations
{
    ...
    [Migration("20250614225635_UpdatePatientMedicalInfoToArrays")]
    partial class UpdatePatientMedicalInfoToArrays
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Odary.Api.Domain.Patient", b =>
                {
                    ...
                    b.HasIndex("IsArchived")
                        .HasDatabaseName("ix_patients_is_archived");
                    ...
                    b.HasIndex("FirstName", "LastName")
                        .HasDatabaseName("ix_patients_first_name_last_name");
            ...
            modelBuilder.Entity("Odary.Api.Domain.User", b =>
                {
                    ...
                    b.PrimitiveCollection<List<string>>("PasswordHistory")
                        .IsRequired()
                        .HasColumnType("text[]")
            ...
            modelBuilder.Entity("Odary.Api.Domain.Patient", b =>
                {
                    b.HasOne("Odary.Api.Domain.Tenant", "Tenant")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_patients_tenants_tenant_id");
